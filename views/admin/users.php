...
<head>
 ...
 <link rel="stylesheet" href="/oil_supply/css/admin_users.css">
</head>
<body>
<div class="app">
 ...
 <td>
 <?php if($u['status']==='active'): ?><span class="badge badge-delivered">Active</span>
...
<div class="modal-overlay" id="uModal">
 ...
 <textarea name="reason" rows="2" placeholder="Enter reason..." required></textarea>
 </div>
