...
<head>
    ...
    <link rel="stylesheet" href="/oil_supply/css/customer_products.css">
</head>
<body>
<div class="app">
                ...
                ?>
                    <div class="product-card">
                        ...
                        <div class="product-card-body">
                            ...
                            <?php endif; ?>
                            <form method="POST" class="add-cart-form" style="display:flex;gap:.4rem;">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll('.add-cart-form').forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            // We append the add_cart name so controllers or endpoints know the action if needed, 
            // though our api.php checks for action=add_cart in the URL
            formData.append('add_cart', '1');

            fetch('/oil_supply/api.php?action=add_cart', {
                method: 'POST',
                body: formData
            })
            .then(res => res.json())
