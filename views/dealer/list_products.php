...
<head>
    ...
    <link rel="stylesheet" href="/oil_supply/css/dealer_list_products.css">
</head>
<body>
<div class="app">
    ...
    <div class="main">
        <div class="topbar">
            <div class="topbar-title">My Listed Products</div>
            <div class="topbar-actions"><a href="?action=add" class="btn btn-primary btn-sm">+ List Product</a></div>
        </div>
        <div class="content">
            <?=$msg?>
